...
use to spawn the default ai bots, you can remove or change it from the init.lua
...
if you are using the bots save function, do not use the characters ,*? it will make all bot inventorys and settings void
...
drowning		1
			(is basically a table, can be one or contain many variables with strings and or numbers. positions will be rounded [x,y,z])
self.save_inventory
self.save_pos
self.save
